...
def nmds(otu_table_txt, otu_classification_txt, min_seq_num, metadata_txt, host_taxon_rank, interested_sample_txt, op_dir, op_prefix, group_color_txt):
    ...
    if len(sample_with_grp_info) < len(otu_table_sample_list):
        ...
        otu_table_subset = otu_table_txt
...
sample_metadata_txt     = 'metadata_20250528.txt'
otu_classification_txt  = 'OTU_Taxa.txt'
interested_sample_txt   = 'interested_sample.txt'
minimum_seq_num         = 10000
group_color_txt         = 'coral_color.txt'
host_taxon_rank         = 'f'

# group by coral family
op_dir                  = 'output_folder'
op_prefix               = 'NMDS_by_coral_family'

########################################################################################################################

nmds(otu_table_txt, otu_classification_txt, minimum_seq_num, sample_metadata_txt, host_taxon_rank, interested_sample_txt, op_dir, op_prefix, group_color_txt)
